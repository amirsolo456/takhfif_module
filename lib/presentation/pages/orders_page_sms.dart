                      ...
                      PopupMenuButton<String>(
                        ...
                        itemBuilder: (context) => const <PopupMenuEntry<String>>[
                          PopupMenuItem<String>(
                            ...
                            child: Row(
                              children: <Widget>[
                                Icon(Icons.sms_outlined, size: 19),
                                SizedBox(width: 10),
                                Text('ارسال پیامک'),
                              ],
                            ),
...
class _DocumentSmsDialogState extends State<_DocumentSmsDialog> {
  ...
  void initState() {
    ...
    _messageController = TextEditingController(
      text:
          'سلام ${widget.customerName}، فاکتور شماره ${widget.factorId} به مبلغ ${_money(widget.totalAmount)} تومان در سیستم ثبت شد.',
    );
  }
  ...
  Future<void> _send() async {
    ...
    try {
      final repository = context.read<SmsApiRepository>();
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('خطا در ارسال پیامک: ${e.toString().replaceFirst('Exception: ', '')}'),
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText:
                      'تعداد کاراکتر: ${_messageController.text.length}  •  قابل ویرایش قبل از ارسال',
