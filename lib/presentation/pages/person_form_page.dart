...
class _PersonFormPageState extends State<PersonFormPage> {
  ...
  void _save() async {
    ...
    final data = {
      ...
      'firstName': _personType == 1 ? _firstNameController.text : null,
      'lastName': _personType == 1 ? _lastNameController.text : null,
      'companyName': _personType == 2 ? _companyController.text : null,
